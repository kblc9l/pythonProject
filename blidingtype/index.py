...
from work_with_db import test_result
    ...
    def keyPressEvent(self, e):
        ...
        if k in self.code_key and self.write:
            ...
            if self.STRING:
                ...
                WindowIndex.generate_text_for_test_result(ex1)
...
def wrong_letter():
    LINEEDIT.setStyleSheet("""border: 1px solid #c71700;""")
...
class WindowIndex(qtw.QMainWindow):
    ...
    def show_result(self, wpm, cpm, accuracy):
        ...
        self.ui.lalue_cpm.setText(f'{cpm}')
        self.ui.value_percent_correct.setText(f'{int(accuracy * 100)}%')


        # запись результатов в бд
        test_result.write_test_result_in_db(wpm, cpm, accuracy)
